...
-- 상품 분류 테이블 
-- mysql에서는 lprod_id 컬럼에 자동 증가값을 사용할 수 없음.
-- Auto_increment를 사용하면 무조건 PK로 생성해야 하는데,,
-- 다른 테이블 생성 시 FK 제약조건 생성 오류가 발생된다.
Create Table lprod ( 
   lprod_id int  not null,					-- 순번
   lprod_gu char(4) not null,					-- 상품분류코드
   lprod_nm varchar(40) not null,				-- 상품분류명
  Constraint lprod_pk Primary Key (lprod_gu)
);
...
-- 상품정보 테이블
CREATE TABLE  prod
(  prod_id             varchar(30)  NOT NULL,     -- 상품코드
   prod_name           varchar(40)  NOT NULL,     -- 상품명
   prod_lgu            char(4)      NOT NULL,     -- 상품분류
   prod_buyer          char(6)      NOT NULL,     -- 공급업체(코드)
   prod_cost           int          NOT NULL,     -- 매입가
   prod_price          int          NOT NULL,     -- 소비자가
   prod_sale           int          NOT NULL,     -- 판매가
   prod_outline        varchar(50)  NOT NULL,     -- 상품개략설명
   prod_detail         text,                      -- 상품상세설명
   prod_img            varchar(40)  NOT NULL,     -- 이미지(소)
   prod_totalstock     int          NOT NULL,     -- 재고수량
   prod_insdate        datetime,                  -- 신규일자(등록일)
   prod_properstock    int          NOT NULL,     -- 안전재고수량
   prod_size           varchar(20),               -- 크기
   prod_color          varchar(20),               -- 색상
   prod_delivery       varchar(255),              -- 배달특기사항
   prod_unit           varchar(6),                -- 단위(수량)
   prod_qtyin          int,                       -- 총입고수량
   prod_qtysale        int,                       -- 총판매수량
   prod_mileage        int,                       -- 개당 마일리지 점수
...
(  buy_date  datetime     NOT NULL,               -- 입고일자
   buy_prod  varchar(30)  NOT NULL,             -- 상품코드
   buy_qty   int          NOT NULL,                      -- 매입수량
   buy_cost  int          NOT NULL,                     -- 매입단가
   Constraint pk_buyprod Primary Key (buy_date,buy_prod),
   Constraint fr_buy_prod Foreign Key (buy_prod) References prod(prod_id)
);


INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-08 00:00:00','P202000001',18,10000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-08 00:00:00','P202000002',19,13000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-08 00:00:00','P202000003',11,15000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-12 00:00:00','P201000001',21,21000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-12 00:00:00','P201000002',13,22000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-12 00:00:00','P201000003',15,23000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-13 00:00:00','P101000001',22,210000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-13 00:00:00','P101000002',23,310000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-13 00:00:00','P101000003',21,410000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-14 00:00:00','P201000004',15,12000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-14 00:00:00','P201000005',32,13000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-14 00:00:00','P201000006',11,14000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-16 00:00:00','P202000007',22,25000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-16 00:00:00','P202000008',33,27000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-16 00:00:00','P202000009',14,28500);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-16 00:00:00','P302000011',125,59000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-16 00:00:00','P302000012',16,89000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-16 00:00:00','P302000013',13,17000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-17 00:00:00','P302000014',21,25000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-17 00:00:00','P302000015',33,22000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-17 00:00:00','P302000016',17,120000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-18 00:00:00','P301000001',15,21000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-18 00:00:00','P301000002',19,17000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-19 00:00:00','P202000010',21,55000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-19 00:00:00','P202000011',91,55000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-19 00:00:00','P202000012',15,55000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-25 00:00:00','P102000003',11,590000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-25 00:00:00','P102000004',13,990000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-25 00:00:00','P102000005',22,1990000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-26 00:00:00','P102000007',52,550000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-27 00:00:00','P302000001',253,89000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-27 00:00:00','P302000002',31,99000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-27 00:00:00','P302000003',197,19000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-28 00:00:00','P201000007',19,31000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-28 00:00:00','P201000008',22,32000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-28 00:00:00','P201000009',26,33000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-31 00:00:00','P302000021',23,23500);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-31 00:00:00','P302000022',17,78500);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-01-31 00:00:00','P302000023',15,21500);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-02-03 00:00:00','P201000010',23,55000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-02-03 00:00:00','P201000011',21,56000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-02
);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-05-29 00:00:00','P202000014',12,120000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-05-29 00:00:00','P202000015',7,130000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-05-30 00:00:00','P201000013',10,110000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-05-30 00:00:00','P201000014',22,120000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-05-30 00:00:00','P201000015',19,130000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-06-01 00:00:00','P202000019',16,210000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-06-01 00:00:00','P202000020',13,220000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-06-01 00:00:00','P202000021',7,230000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-06-03 00:00:00','P102000001',9,690000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-06-03 00:00:00','P102000002',6,890000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-06-04 00:00:00','P102000006',7,660000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-06-09 00:00:00','P201000016',19,100000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-06-09 00:00:00','P201000017',35,110000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-06-09 00:00:00','P201000018',25,120000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-06-10 00:00:00','P201000019',10,210000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-06-10 00:00:00','P201000020',33,220000);
INSERT INTO buyprod(buy_date,buy_prod,buy_qty,buy_cost) VALUES('2005-06-10 00:00:00','P201000021',26,230000);
...
-- 회원정보 테이블 생성
CREATE TABLE  member
(  mem_id                varchar(15)  NOT NULL,    -- 회원ID  
   mem_pass              varchar(15)  NOT NULL,    -- 비밀번호
   mem_name              varchar(10)  NOT NULL,    -- 성명
   mem_regno1            char(6)   NOT NULL,           -- 주민등록번호앞6자리
   mem_regno2            char(7)   NOT NULL,           -- 주민등록번호뒤7자리
   mem_bir               datetime,                             -- 생일
   mem_zip               char(7)      NOT NULL,       -- 우편번호
   mem_add1              varchar(60)  NOT NULL,   -- 주소1
   mem_add2              varchar(50)  NOT NULL,   -- 주소2
   mem_hometel           varchar(14)  NOT NULL,   -- 집전화번호                                
   mem_comtel            varchar(14)  NOT NULL,  -- 회사전화번호                              
   mem_hp                varchar(15),                       -- 이동전화
   mem_mail              varchar(40)  NOT NULL,   -- E-mail주소
   mem_job               varchar(40),                       -- 직업
   mem_like              varchar(40),                        -- 취미
   mem_memorial          varchar(40),                        -- 기념일명
   mem_memorialday       datetime,                              -- 기념일날짜
   mem_mileage           int,                                       -- 마일리지              
   mem_delete            varchar(1),                          -- 삭제여부
...
INSERT INTO member (mem_id,mem_pass,mem_name,mem_regno1,mem_regno2,mem_bir,mem_zip,mem_add1,mem_add2,mem_hometel,
                    mem_comtel,mem_hp,mem_mail,mem_job,mem_like,mem_memorial,mem_memorialday,mem_mileage,mem_delete)
       VALUES ('o001','0909','배인정','780930','2447619','780930','306-702','대전시 서구 갈마동','경성아파트502동1101호','042-622-5971',
               '042-622-5971','011-622-5971','tar-song@hanmail.net','회사원','등산','어머님생신','1999-03-12',2600,'');
INSERT INTO member (mem_id,mem_pass,mem_name,mem_regno1,mem_regno2,mem_bir,mem_zip,mem_add1,mem_add2,mem_hometel,
                    mem_comtel,mem_hp,mem_mail,mem_job,mem_like,mem_memorial,mem_memorialday,mem_mileage,mem_delete)
       VALUES ('p001','sahra3','오성순','730805','2458323','19730805','306-702','대전유성구송강동','한솔아파트 703동 407호','042-810-7658',
...
INSERT INTO member (mem_id,mem_pass,mem_name,mem_regno1,mem_regno2,mem_bir,mem_zip,mem_add1,mem_add2,mem_hometel,
                    mem_comtel,mem_hp,mem_mail,mem_job,mem_like,mem_memorial,mem_memorialday,mem_mileage,mem_delete)
       VALUES ('w001','12341234','김형모','631213','1111111','631213','306-702','대전시 대덕구 연축동','23-43','02-345-9877',
...
INSERT INTO member (mem_id,mem_pass,mem_name,mem_regno1,mem_regno2,mem_bir,mem_zip,mem_add1,mem_add2,mem_hometel,
                    mem_comtel,mem_hp,mem_mail,mem_job,mem_like,mem_memorial,mem_memorialday,mem_mileage,mem_delete)
       VALUES ('jang001','0000','장대근','770319','2110222','1977-03-19','306-702','대전광역시 동구 오정동','43-26','042-223-8767',
               '042-223-8767','019-223-8767','happysong@hanmail.net','회장','독서','결혼기념일','1999-02-12',8700,'');
INSERT INTO member (mem_id,mem_pass,mem_name,mem_regno1,mem_regno2,mem_bir,mem_zip,mem_add1,mem_add2,mem_hometel,
                    mem_comtel,mem_hp,mem_mail,mem_job,mem_like,mem_memorial,mem_memorialday,mem_mileage,mem_delete)
       VALUES ('kim001','0000','김성관','770319','2110222','1977-03-19','306-702','대전광역시 동구 오정동','43-26','042-223-8767',
               '042-223-8767','019-223-8767','happysong@hanmail.net','쌍둥이','독서','결혼기념일','1999-02-12',8700,'');
INSERT INTO member (mem_id,mem_pass,mem_name,mem_regno1,mem_regno2,mem_bir,mem_zip,mem_add1,mem_add2,mem_hometel,
                    mem_comtel,mem_hp,mem_mail,mem_job,mem_like,mem_memorial,mem_memorialday,mem_mileage,mem_delete)
       VALUES ('song001','0000','송치호','770319','2110222','1977-03-19','306-702','대전광역시 동구 오정동','43-26','042-223-8767',
               '042-223-8767','019-223-8767','happysong@hanmail.net','쌍둥이','독서','결혼기념일','1999-02-12',8700,'');
INSERT INTO member (mem_id,mem_pass,mem_name,mem_regno1,mem_regno2,mem_bir,mem_zip,mem_add1,mem_add2,mem_hometel,
                    mem_comtel,mem_hp,mem_mail,mem_job,mem_like,mem_memorial,mem_memorialday,mem_mileage,mem_delete)
       VALUES ('bak001','0000','박지혜','770319','2110222','1977-03-19','306-702','대전광역시 동구 오정동','43-26','042-223-8767',
               '042-223-8767','019-223-8767','happysong@hanmail.net','반장','독서','결혼기념일','1999-02-12',8700,'');
